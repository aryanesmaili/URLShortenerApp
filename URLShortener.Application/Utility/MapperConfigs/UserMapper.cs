...
namespace URLShortenerAPI.Responses.MapperConfigs
{
    ...
    public class UserURLsResolver(IMapper mapper) : IValueResolver<UserModel, UserDTO, List<URLDTO>?>
    {
    ...
    public class UserCategoriesResolver(IMapper mapper) : IValueResolver<UserModel, UserDTO, List<CategoryDTO>?>
    {
        private readonly IMapper _mapper = mapper;
